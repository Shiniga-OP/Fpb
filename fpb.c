            ...
            while(1) {
                if(L.tk.tipo == T_TEX) {
                    ...
                    if(L.tk.tipo == T_INT) {
                        ...
                        double d_val = L.tk.valor_d;
                        int titulo = add_const(L.tk.tipo, num, d_val, 0);
                        carregar_const(s, titulo);
                        if(L.tk.tipo == T_FLU) fprintf(s, "  bl _escrever_flu\n");
                        else fprintf(s, "  bl _escrever_double\n");
                    }
                    proximoToken();
